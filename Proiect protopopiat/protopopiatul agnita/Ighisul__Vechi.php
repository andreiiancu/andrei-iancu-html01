...
<head>
  ...
  <title>Parohia Ortodoxă Ighișul Vechi</title>
</head>
<body>
  <?php
    ...
    >
      ...
      >
        ...
        "
          ...
          <h3><span>Parohia Ortodoxă Ighișul Vechi</span></h3>
          <p> Biserica cu hramul „Sfinţii Arhangheli Mihail şi Gavriil”</p>
       </div>
        ...
        <div
          ...
          <div class="col-lg-6">
            <div class="info-box mb-4">
              ...
              <h3>Adresa</h3>
              <p>Localitatea Ighișul Vechi, jud. Sibiu</p>
            </div>
          </div>
        ...
        <div class="row">
          ...
          >
            <img
              ...
              alt=""
            > <span style="margin-left: 1rem" class="text-danger"><i>FOTO: Biserica cu hramul „Sfinţii Arhangheli Mihail şi Gavriil” Ighișul Vechi </i></span>
          </div>
          <div
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-4 col-sm-6">
            <div class="our-team">
                <img src="../protopopiatul agnita/assets/img/poze__parohii/Ighisul Vechi/ee254cd3-e79d-434c-adc4-1de7d078b635.jpg" style="height:30rem;">
                <div class="team-content">
                    <h3 class="title">Pr. Daniel CRIȘCĂ</h3>
                    <ul class="social">
